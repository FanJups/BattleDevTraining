...
https://www.google.com/search?q=arraylist+java&oq=Arraylist+&aqs=chrome.1.69i57j0j35i39l2j0l2.6361j1j7&sourceid=chrome&ie=UTF-8

https://www.w3schools.com/java/java_arraylist.asp

### How do I know if 2 alphabetic letters follow each other? java

https://www.google.com/search?ei=mXOCXOD_NIqyUvXNvagH&q=How+do+I+know+if+2+alphabetic+letters+follow+each+other%3F+java&oq=How+do+I+know+if+2+alphabetic+letters+follow+each+other%3F+java&gs_l=psy-ab.3...2246.3402..4016...0.0..0.159.557.1j4......0....1..gws-wiz.......0i71j35i39j33i21j33i160.wCIw4dP36iw

https://stackoverflow.com/questions/8108478/determine-alphabetic-order-of-two-characters-in-java

https://www.geeksforgeeks.org/check-if-the-characters-of-a-given-string-are-in-alphabetical-order/

### Arrays.sort java

https://www.google.com/search?q=Arrays.sort+java&oq=Arrays.sort+java&aqs=chrome..69i57j0l5.6194j1j7&sourceid=chrome&ie=UTF-8

https://www.geeksforgeeks.org/arrays-sort-in-java-with-examples/

### how to know if a letter is alphabetical ? java

https://www.google.com/search?q=how+to+know+if+a+letter+is+alphabetical+%3F+java&oq=how+to+know+if+a+letter+is+alphabetical+%3F+java&aqs=chrome..69i57.30402j1j7&sourceid=chrome&ie=UTF-8
...
### how to know that an accented letter is not alphabetical java ?

https://www.google.com/search?q=how+to+know+that+an+accented+letter+is+not+alphabetical+java+%3F&oq=how+to+know+that+an+accented+letter+is+not+alphabetical+java+%3F&aqs=chrome..69i57.37159j1j7&sourceid=chrome&ie=UTF-8

https://stackoverflow.com/questions/3614674/ignoring-diacritics-when-ordering-alphabetically

### locale france java

https://www.google.com/search?q=locale+france+java&oq=locale+france+java&aqs=chrome..69i57j0.4378j0j7&sourceid=chrome&ie=UTF-8

https://docs.oracle.com/javase/7/docs/api/java/util/Locale.html

https://docs.oracle.com/javase/7/docs/api/java/util/Locale.html#FRANCE

### collator java

https://www.google.com/search?q=collator+java&oq=collator+java&aqs=chrome..69i57j0l5.4381j1j7&sourceid=chrome&ie=UTF-8

https://docs.oracle.com/javase/7/docs/api/java/text/Collator.html

http://www.eteks.com/tips/tip4.html

### how to know if a letter is alphabetical using collator ? java

https://www.google.com/search?ei=HX2CXJbANaOvgweE-rzYDA&q=how+to+know+if+a+letter+is+alphabetical+using+collator+%3F+java&oq=how+to+know+if+a+letter+is+alphabetical+using+collator+%3F+java&gs_l=psy-ab.3...1093.6518..7640...0.0..0.276.1668.7j7j1......0....1..gws-wiz.......33i10.KOsS6uwtgZY
